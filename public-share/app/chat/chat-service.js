...
var ChatService = (function () {
    ...
    ChatService.prototype.momentUpdate = function () {
    ...
    ChatService.prototype.updateSocketChatMessage = function () {
        ...
        this.socket.on("chat_message", function (msg, username, datetime) {
            _this.zone.run(function () {
                ...
                _this.updateScroll();
                console.log('this is the new this.messages with pushed in data ', _this.messages);
                console.log('killing setInterval');
                clearInterval(_this.runMomentUpdate);
